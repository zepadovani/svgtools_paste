...
def get_svg_info(svg_path):
    ...
    return {'root': root, 'viewbox': viewbox, 'ratio': ratio}
...
def paste_group_with_scaling(container_path, to_paste_path, output_path, group_id, x_mm, y_mm):
    ...
    # Cria um grupo <g> para aplicar o posicionamento (translate) e a escala (scale)
    # A ordem é importante: primeiro escala, depois translada.
    # Mas como o translate é em mm, aplicamos no container que já está em mm.
    ...
    # Cria o grupo que vai receber o conteúdo
    ...
    # Salva o resultado
    tree = ET.ElementTree(container_root)
